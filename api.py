    ...
    try:
        ...
        if cursor.fetchone()[0] == 0:
            skus_carga = [
                ...
                ('7801084', 'P50 IGUAÇU', 50, 4, 25), ('7801000', 'M20 IGUAÇU', 20, 6, 30),
                ('7801087', 'M58 IGUAÇU', 58, 4, 15), ('7801130', 'M34 D&N', 34, 4, 30),
                ('7801133', 'M1 D&N', 1, 60, 36), ('7801138', 'M68 D&N', 68, 2, 33),
                ('7801001', 'G17 IGUAÇU', 17, 6, 36), ('7801088', 'G50 IGUAÇU', 50, 4, 20),
                ('7801093', 'G64 D&N', 32, 4, 27), ('7801131', 'G30 D&N', 30, 4, 30),
                ('7801134', 'G1 D&N', 1, 60, 36), ('7801139', 'G60 D&N', 60, 2, 33),
                ('8010020', 'P24 Cuidado Real', 24, 6, 24), ('7801017', 'P24 IGUAÇU', 24, 6, 24),
                ('7801091', 'P46 D&N', 46, 4, 25), ('7801108', 'P34 D&N', 34, 6, 18),
                ('7801049', 'XXG13 IGUAÇU', 13, 6, 32), ('7801073', 'XXG24 IGUAÇU', 24, 4, 28)
            ]
            for s in skus_carga:
        ...
        if cursor.fetchone()[0] == 0:
            paradas_baby = [
                ...
                ('10', 'Outros problemas Absorção'), ('11', 'Linha Inner Film'), ('12', 'Linha Center Top'),
                ('13', 'Linha LSG NW'), ('14', 'Linha LG1 Lycra'), ('15', 'Linha LG2 Lycra'),
                ('40', 'Linha 2 dobras'), ('41', 'Sonic'), ('42', 'Na entrega da linha para TU'),
                ('43', 'Linha de Transporte entre Sonic e TU'), ('61', 'Parte de trás geral Correia, polia'),
                ('65', 'Erro humano(trabalho operador)'), ('67', 'HMA Tank A'), ('68', 'HMA Tank B'),
                ('101', 'OPTIMA STACKER'), ('115', 'Esteira de embalagem'), ('124', 'Defeito no material (SAP)')
            ]
            for num, prob in paradas_baby:
                cursor.execute("INSERT INTO codigos_parada (tipo_maquina, numero, problema) VALUES ('baby_care', %s, %s) ON CONFLICT (tipo_maquina, numero) DO NOTHING;", (num, prob))

            paradas_adult = [
                ('1', 'Problemas no triturador (mill)'), ('2', 'Linha do Pulp'), ('3', 'Alimentador de polímero'),
                ('6', 'Envolvimento do tissue na absorção'), ('7', 'Core press'), ('8', 'Diamond emboss'),
                ('11', 'Linha do tissue'), ('12', 'Linha inner back film'), ('13', 'Linha inner top'),
                ('40', 'Sonic'), ('41', 'Na entrega da linha para TU'), ('65', 'Erro Humano (operador)'),
                ('67', 'HMA TANK A'), ('83', 'Emenda Pulp'), ('84', 'Emenda TISSUE'), ('93', 'Optima Stacker')
            ]
            for num, prob in paradas_adult:
                cursor.execute("INSERT INTO codigos_parada (tipo_maquina, numero, problema) VALUES ('adult_care', %s, %s) ON CONFLICT (tipo_maquina, numero) DO NOTHING;", (num, prob))
        conn.commit()
        ...
        cursor.execute("""
            CREATE TABLE IF NOT EXISTS result_by_order (
                ...
                run_time INT NOT NULL, machine_counter INT NOT NULL, pallets INT NOT NULL,
                fardos_avulsos INT NOT NULL, tipo_tno VARCHAR(100), tempo_tno INT DEFAULT 0,
